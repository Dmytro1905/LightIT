...
while (player.health > 0 and computer.health > 0): # создаем цикл работы программы до тех пор, пока здоровье Игрока и Противника больше 0
    ...
    if player_choice == 2: # описание случая, если выбор хода пал на Противника
        ...
        if computer.health > 35: # описание ситуации, если количество очков (процентов) здоровья Противника более 35
        ...
        if computer.health <= 35: # описание ситуации, если количество очков (процентов) здоровья Противника менее или равно 35
